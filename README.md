...
ItemDisplay[r14]: %TAN%%RUNENAME% 14 
...
ItemDisplay[WP12 !wnd !ywn !9wn NMAG (SK83>1 AND SK84>1 AND SK79>1) !SOCK=1]: %GREEN%%NAME% %PURPLE%[%SOCKETS%]
...
//Shield
ItemDisplay[NMAG !ETH !RW SOCK>2 ush]: %NAME% [%SOCKETS%]
ItemDisplay[NMAG !ETH !RW SOCK>3 uit]: %NAME% [%SOCKETS%]
ItemDisplay[NMAG !ETH !RW SOCK>2 urg]: %NAME% [%SOCKETS%]
ItemDisplay[NMAG !ETH !RW SOCK=0 ush]: %GRAY%%NAME%
ItemDisplay[NMAG !ETH !RW SOCK=0 uit]: %GRAY%%NAME%
ItemDisplay[NMAG !ETH !RW SOCK=0 urg]: %GRAY%%NAME%
ItemDisplay[NMAG ETH !RW SOCK>2 ush]: ETH %NAME% [%SOCKETS%]
ItemDisplay[NMAG ETH !RW SOCK>2 uit]: 
ItemDisplay[NMAG ETH !RW SOCK>2 urg]: ETH %NAME% [%SOCKETS%]
//
...
ItemDisplay[NMAG !RW CL4 ILVL>24 !SOCK=1 (SK84>2 OR SK67>2 OR SK92>2)]: %DGREEN%%NAME%
